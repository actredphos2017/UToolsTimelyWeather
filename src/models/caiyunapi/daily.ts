...
export function getDailyUrl(token: string, position: LongLatitude = defaultLongLatitude): string {
    return `https://api.caiyunapp.com/v2.6/TAkhjf8d1nlSlspN/${parseCaiyunLLFormat(position)}/daily?dailysteps=1&token=${token}`
}
