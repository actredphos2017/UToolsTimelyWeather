...
export function getHourlyUrl(token: string, position: LongLatitude = defaultLongLatitude): string {
    return `https://api.caiyunapp.com/v2.6/TAkhjf8d1nlSlspN/${parseCaiyunLLFormat(position)}/hourly?hourlysteps=1&token=${token}`
}
